  ...
  const exportToPDF = () => {
    try {
      ...
      autoTable(doc, {
        ...
        columnStyles: {
          0: { cellWidth: 10 }, // Song # column
          1: { cellWidth: 40 }, // Title column
          2: { cellWidth: 18 }, // Duration column
          3: { cellWidth: 23 }, // Electric Guitar
          4: { cellWidth: 23 }, // Acoustic Guitar
          5: { cellWidth: 18 }, // Bass
          6: { cellWidth: 18 }, // Vocals
          7: { cellWidth: 23 }  // Backup Vocals
        },
